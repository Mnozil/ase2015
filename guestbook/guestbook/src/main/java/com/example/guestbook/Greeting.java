...
public class Greeting {
    ...
    public String toXML() {
        ...
        sb.openTag("greeting", true);
        for (Field field : Greeting.class.getDeclaredFields()) {
            if (field.getName().equals("theBook")) continue;
            sb.openTag(field.getName(), false);
            try {
